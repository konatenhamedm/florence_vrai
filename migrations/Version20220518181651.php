...
final class Version20220518181651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courier_arrive (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, exp_id INT DEFAULT NULL, expediteur_id INT DEFAULT NULL, recep_id INT DEFAULT NULL, numero VARCHAR(255) NOT NULL, date_reception DATETIME NOT NULL, objet LONGTEXT NOT NULL, chambre VARCHAR(255) NOT NULL, active VARCHAR(255) NOT NULL, etat TINYINT(1) DEFAULT NULL, type VARCHAR(255) NOT NULL, existe TINYINT(1) DEFAULT NULL, rangement VARCHAR(255) NOT NULL, INDEX IDX_90FA9925A76ED395 (user_id), INDEX IDX_90FA9925D26628FA (exp_id), INDEX IDX_90FA992510335F61 (expediteur_id), INDEX IDX_90FA99257F5413B1 (recep_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
